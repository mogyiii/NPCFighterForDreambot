...
public class DrinkPotions {
    ...
    public void CheckCanDrinkPotion(){
        ...
        if(Skills.getRealLevel(Skill.PRAYER) >= _factory.getMain().getSkills().getBoostedLevels(Skill.PRAYER)){
        ...
        if(Skills.getRealLevel(Skill.ATTACK) >= _factory.getMain().getSkills().getBoostedLevels(Skill.ATTACK)){
            for(int i = 0; i < PotionsModel.length; i ++){
        ...
        if(Skills.getRealLevel(Skill.STRENGTH) >= _factory.getMain().getSkills().getBoostedLevels(Skill.STRENGTH)){
            for(int i = 0; i < PotionsModel.length; i ++){
        ...
        if(Skills.getRealLevel(Skill.RANGED) >= _factory.getMain().getSkills().getBoostedLevels(Skill.RANGED)){
            for(int i = 0; i < PotionsModel.length; i ++){
        ...
        if(Skills.getRealLevel(Skill.MAGIC) >= _factory.getMain().getSkills().getBoostedLevels(Skill.MAGIC)){
            for(int i = 0; i < PotionsModel.length; i ++){
